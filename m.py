...
bot = telebot.TeleBot('7967383352:AAHzsFLtML16vgCISIMETxgDTXRJYCLwun8')
...
✅ Usage: /remove <userid>'''
        ...
        response = "You have not purchased yet purchase now from:- @Mulia_babu 🙇."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- @Mulia_babu 🙇."
    bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- @Mulia_babu")
...
def welcome_start(message):
    ...
    response = f'''❄️𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐏𝐫𝐞𝐦𝐢𝐮𝐦 𝐃𝐎𝐃𝐎𝐒 𝐁𝐨𝐭, {Mulia_babu}! 𝐓𝐡𝐢𝐬 𝐈𝐬 𝐇𝐢𝐠𝐡 𝐐𝐮𝐚𝐥𝐢𝐭𝐲 𝐒𝐞𝐫𝐯𝐞𝐫 𝐁𝐚𝐬𝐞𝐝 𝐃𝐃𝐎𝐒. 𝐓𝐎 𝐆𝐄𝐓 𝐀𝐂𝐂𝐄𝐒𝐒..
...
3. MAKE SURE YOU JOINED https://t.me/+hYJLR7mRWc8zOGY9 OTHERWISE NOT WORK
